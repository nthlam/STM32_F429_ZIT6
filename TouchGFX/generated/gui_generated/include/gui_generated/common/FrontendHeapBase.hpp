...
public:
    ...
    typedef touchgfx::meta::TypeList< StartScreenView,
            touchgfx::meta::TypeList< SelectHardwareScreenView,
            touchgfx::meta::TypeList< ButtonScreenView,
            touchgfx::meta::TypeList< LoadcellScreenView,
    ...
    typedef touchgfx::meta::TypeList< StartScreenPresenter,
            touchgfx::meta::TypeList< SelectHardwareScreenPresenter,
            touchgfx::meta::TypeList< ButtonScreenPresenter,
            touchgfx::meta::TypeList< LoadcellScreenPresenter,
